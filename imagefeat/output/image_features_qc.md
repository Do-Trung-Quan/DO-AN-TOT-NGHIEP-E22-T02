# Bao cao kiem dinh dac trung anh (QC) — bo CROSSFIT

- Sinh luc: 2026-09-06T09:46:44.956908+00:00
...
| 6 | Cosine TB (raw) | `0.6271` | bao cao | — |
| 6 | Cosine TB (da mean-center) | `0.0084` | bao cao | — |
| 7 | Effective rank | `5.56/256` | bao cao | — |
| 7 | Phuong sai PC1 | `48.6%` | bao cao | — |
| 8 | PR-AUC probe tren nhan bnn | `0.2054 (nen 0.0540)` | bao cao | — |
| 9 | Do chinh xac doan lo chup | `42.1% (nen theo lop lon nhat 10.9%, 16 lo, 1824 anh)` | bao cao | — |

## Doc chi so 6 — quan trong cho phase fusion

Cosine trung binh raw = **0.6271**, sau mean-centering = **0.0084**.
